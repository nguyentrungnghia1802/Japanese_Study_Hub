...
echo "The daily backup schedule is ${BACKUP_MINUTE} ${BACKUP_HOUR} * * * and becomes effective after the manual runtime scripts are installed and state/current_sha exists."
